...
namespace LGMS.Migrations
{
    ...
    [Migration("20241109134632_AddingDateColumnInPaymentsTable")]
    partial class AddingDateColumnInPaymentsTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LGMS.Data.Model.Contract", b =>
                {
                    b.HasOne("LGMS.Data.Model.Client", "ClientInformation")
                        .WithMany()
            ...
            modelBuilder.Entity("LGMS.Data.Model.ContractPackageInformation", b =>
                {
                    b.HasOne("LGMS.Data.Model.Contract", "Contract")
                        .WithOne("PackageInformation")
                        .HasForeignKey("LGMS.Data.Model.ContractPackageInformation", "ContractId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("LGMS.Data.Model.Expiration", b =>
                {
                    b.HasOne("LGMS.Data.Model.Contract", null)
