...
namespace LGMS.Migrations
{
    ...
    [Migration("20241106092212_AddingQuotationDbset")]
    partial class AddingQuotationDbset
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("LGMS.Data.Model.Quotation", b =>
                {
                    ...
                    b.HasOne("LGMS.Data.Model.QuotationPackageInformation", "PackageInformation")
                        .WithMany()
