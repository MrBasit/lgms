    ...
    public class AttendanceReportService
    {
        public AttendanceReportDTO GenerateReport(string employeeName, List<AttendanceRecord> attendanceRecords)
        {
            var report = new AttendanceReportDTO
            {
                ...
                Weekends = attendanceRecords.Count(a => a.Status.Title == "Weekend") + attendanceRecords.Count(a => a.Status.Title == "Holiday") + attendanceRecords.Count(a => a.Status.Title == "On Leave"),
                TotalDays = 0,
